...
import { FaArrowLeft, FaImages, FaMapMarkerAlt } from 'react-icons/fa';
    ...
    if (projectId) {
      const fetchProjectDetails = async () => {
        try {
          ...
          setError(
            'Không thể tải dữ liệu công trình. Công trình có thể không tồn tại hoặc đã có lỗi xảy ra.'
          );
          setLoading(false);
        }
      };
    ...
    <main className="min-h-screen bg-gray-50 py-12">
      ...
      <div className="container mx-auto px-4">
        ...
        <article className="bg-white shadow-xl rounded-lg overflow-hidden">
          ...
          {project.thumbnail && (
            <div
              className="relative h-80 md:h-96 lg:h-[500px] w-full cursor-pointer group"
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="prose prose-lg max-w-none mb-12 post-content">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: renderCKEditorContent(project.detailedContent),
                }}
              />
            </div>
            ...
            <div className="pt-8 border-t border-gray-200 text-center">
              ...
              <p className="text-gray-700 mb-6 max-w-xl mx-auto">
                Chúng tôi sẵn sàng tư vấn và thi công rèm cửa cho công trình của
                bạn với chất lượng tốt nhất.
              </p>
              <Link
                href="/contact"
