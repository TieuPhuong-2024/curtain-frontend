        ...
        <div className="container mx-auto px-4">
          <div className="cozy-card overflow-hidden">
            ...
            <div className="mt-4">
              <Link
                href="/products"
                className="cozy-link font-medium flex items-center"
              >
          ...
          <div className="flex flex-col lg:flex-row">
              ...
              <div className="flex flex-col">
                ...
                {images.length > 1 && (
                  <div className="flex flex-wrap gap-2 mt-4 py-2 justify-center sm:justify-start">
                    ...
                    <div
                      className={`relative w-16 h-16 sm:w-20 sm:h-20 min-w-[4rem] sm:min-w-[5rem] cursor-pointer rounded-md overflow-hidden border-2 shadow-sm ${
            ...
            <div className="w-full lg:w-1/2 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                <h1 className="cozy-title mb-2 text-xl sm:text-2xl md:text-3xl">
                  {name}
                </h1>
              ...
              <div className="mb-6">
                <p className="text-[#5b4636] mb-4 text-sm sm:text-base">
                  {description}
                </p>
                <div className="space-y-3 bg-[#f8f5f1] p-3 rounded-lg shadow-sm">
                    ...
                    <div className="flex items-center ml-2">
                      {selectedColor ? (
                        <button
                          ...
                          style={{
                            backgroundColor:
                              selectedColor.hexCode || 'transparent',
                          }}
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-[#5b4636] font-semibold">
                      Chất liệu:{' '}
                    </span>
