...
import { FaEdit, FaPlus, FaSave, FaTimes, FaUpload } from 'react-icons/fa';
import {
  addImageToCurtain,
  deleteImage,
  getCurtainById,
  getImagesByCurtainId,
  updateCurtain,
  uploadImage,
} from '@/lib/api';
import { createCategory, getCategories } from '@/lib/categoryApi';
import { createColor, getColorById, getColors, updateColor } from '@/lib/colorApi';
...
export default function EditCurtain({ params }) {
  ...
  const fetchCurtainData = async () => {
    try {
      ...
      if (
        !curtainData.images ||
        !Array.isArray(curtainData.images) ||
        curtainData.images.length === 0
      ) {
        try {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            <div className="flex justify-between items-center">
              <label className="block text-sm font-medium text-gray-700">Tất cả hình ảnh</label>
              <button
                type="button"
              ...
              <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-4">
                {imageList.map(img => (
                  <div key={img._id} className="relative group">
                    <div
                      className={`relative h-32 border rounded-md overflow-hidden ${formData.mainImage === img.url
                ...
                {newColorHexCode && (
                  <div className="flex items-center mb-4">
                    <div
                      ...
                      style={{ backgroundColor: newColorHexCode }}
                    ></div>
