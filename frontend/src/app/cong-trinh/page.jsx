        ...
        <main className="min-h-screen">
            ...
            <section className="relative h-[50vh] min-h-[350px] bg-[#F9F3E0] flex items-center">
                ...
                <div className="container mx-auto px-4 z-10 text-[#6B4F4A]">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">Công Trình Đã Thi Công</h1>
            ...
            <section className="py-20 bg-[#FFF9F2]">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-10">
                        <h2 className="text-3xl font-bold text-[#5B3A29] mb-4 md:mb-0 relative after:content-[''] after:absolute after:h-1 after:w-20 after:bg-[#7C5C52] after:bottom-0 after:left-0 after:-mb-2 pb-3">Dự Án Nổi Bật</h2>
                        <Link href="#all-projects" className="group flex items-center text-[#7C5C52] hover:text-[#5B3A29] transition-colors font-medium">
                            Xem tất cả <FaArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                        </Link>
                    </div>
                    ...
                    {!loading && featuredProjects.length > 0 && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {featuredProjects.map((project, index) => (
                                <div key={project._id} className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group">
                                    ...
                                    <div className="p-6">
                                        <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#5B3A29] transition-colors">{project.title}</h3>
                                        <p className="text-gray-700 mb-4 line-clamp-2">{project.shortDescription || project.description}</p>
                                        ...
                                        <Link href={`/cong-trinh/${project._id}`} className="inline-flex items-center bg-[#7C5C52] text-white px-4 py-2 rounded-lg hover:bg-[#5B3A29] transition shadow-sm">
                                            Xem chi tiết
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        <div className="p-6 rounded-lg bg-white/60 backdrop-blur-sm shadow-md">
                            <div className="text-3xl md:text-5xl font-bold mb-1">{process.env.NEXT_PUBLIC_PROJECTS_COMPLETED || "200+"}</div>
                            <div className="mt-2 text-[#7C5C52] font-medium">Dự án đã hoàn thành</div>
                        </div>
                        <div className="p-6 rounded-lg bg-white/60 backdrop-blur-sm shadow-md">
                            <div className="text-3xl md:text-5xl font-bold mb-1">{process.env.NEXT_PUBLIC_HAPPY_CUSTOMERS || "100+"}</div>
                            <div className="mt-2 text-[#7C5C52] font-medium">Khách hàng hài lòng</div>
                        </div>
                        <div className="p-6 rounded-lg bg-white/60 backdrop-blur-sm shadow-md">
                            <div className="text-3xl md:text-5xl font-bold mb-1">{process.env.NEXT_PUBLIC_YEARS_OF_EXPERIENCE || "10+"}</div>
                            <div className="mt-2 text-[#7C5C52] font-medium">Năm kinh nghiệm</div>
                        </div>
                        <div className="p-6 rounded-lg bg-white/60 backdrop-blur-sm shadow-md">
                            <div className="text-3xl md:text-5xl font-bold mb-1">{process.env.NEXT_PUBLIC_TYPES_OF_CURTAINS || "20+"}</div>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="mb-12">
                        ...
                        <div className="hidden md:flex flex-wrap gap-3 justify-center">
                            <button
                                className={`cursor-pointer rounded-full px-5 py-2.5 font-medium transition-all duration-200 ${activeFilter === "all" ? "bg-[#7C5C52] text-white shadow-md" : "bg-white text-[#7C5C52] border border-[#D4BFA6] hover:border-[#7C5C52]"}`}
                            ...
                            {projectTypes.map((type) => (
                                <button
                                    key={type}
                                    className={`cursor-pointer rounded-full px-5 py-2.5 font-medium transition-all duration-200 ${activeFilter === type ? "bg-[#7C5C52] text-white shadow-md" : "bg-white text-[#7C5C52] border border-[#D4BFA6] hover:border-[#7C5C52]"}`}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                                {filteredProjects.length > 0 ? (
                                    visibleFilteredProjects.map((project, index) => (
                                        <div key={project._id || project.id} className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group">
                                            <div className="relative h-64 overflow-hidden">
                                                {project.thumbnail ? (
                                                    <Image
                                                        src={project.thumbnail}
                                            ...
                                            <div className="p-6">
                                                ...
                                                <Link href={`/cong-trinh/${project._id || project.id}`} className="inline-flex items-center bg-[#7C5C52] text-white px-4 py-2 rounded-lg hover:bg-[#5B3A29] transition shadow-sm">
                                                    Xem chi tiết
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                                    </svg>
                                    ...
                                    <div className="col-span-3 text-center py-16 text-gray-600 bg-[#FFF9F2] rounded-xl border border-[#D4BFA6]">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto mb-4 text-[#7C5C52]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-[#D4BFA6]">
                            <div className="w-16 h-16 bg-[#EADFCF] text-[#7C5C52] rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-inner">1</div>
                            <h3 className="font-semibold mb-3 text-center text-[#5B3A29]">Khảo sát và tư vấn</h3>
                            <p className="text-gray-600 text-sm text-center">Đội ngũ đến tận nơi đo đạc, tư vấn mẫu mã phù hợp với không gian của bạn.</p>
                        </div>

                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-[#D4BFA6]">
                            <div className="w-16 h-16 bg-[#EADFCF] text-[#7C5C52] rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-inner">2</div>
                            <h3 className="font-semibold mb-3 text-center text-[#5B3A29]">Báo giá & ký hợp đồng</h3>
                            <p className="text-gray-600 text-sm text-center">Gửi báo giá chi tiết, minh bạch và ký hợp đồng nếu khách hàng đồng ý.</p>
                        </div>

                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-[#D4BFA6]">
                            <div className="w-16 h-16 bg-[#EADFCF] text-[#7C5C52] rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-inner">3</div>
                            <h3 className="font-semibold mb-3 text-center text-[#5B3A29]">Thi công lắp đặt</h3>
                            <p className="text-gray-600 text-sm text-center">Lắp đặt rèm đúng kỹ thuật, đảm bảo an toàn và vệ sinh sạch sẽ sau khi hoàn thành.</p>
                        </div>

                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-[#D4BFA6]">
                            <div className="w-16 h-16 bg-[#EADFCF] text-[#7C5C52] rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-inner">4</div>
                            <h3 className="font-semibold mb-3 text-center text-[#5B3A29]">Nghiệm thu & bàn giao</h3>
                            <p className="text-gray-600 text-sm text-center">Khách hàng kiểm tra, nghiệm thu và được hướng dẫn cách sử dụng sản phẩm.</p>
                        </div>

                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-[#D4BFA6]">
                            <div className="w-16 h-16 bg-[#EADFCF] text-[#7C5C52] rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-inner">5</div>
                            <h3 className="font-semibold mb-3 text-center text-[#5B3A29]">Hỗ trợ sau lắp đặt</h3>
                            <p className="text-gray-600 text-sm text-center">Bảo hành, bảo trì và hỗ trợ kỹ thuật tận tình sau khi bán hàng.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-xl shadow-md border border-[#D4BFA6] hover:shadow-lg transition-shadow">
                            ...
                            <p className="italic text-gray-700 border-l-4 border-[#D4BFA6] pl-4 py-1">"Rèm cửa được lắp rất nhanh, đẹp và đúng ý tôi. Đội ngũ thi công chuyên nghiệp, tư vấn tận tình. Tôi rất hài lòng!"</p>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md border border-[#D4BFA6] hover:shadow-lg transition-shadow">
                            ...
                            <p className="italic text-gray-700 border-l-4 border-[#D4BFA6] pl-4 py-1">"Chất lượng rèm rất tốt, màu sắc đúng như mẫu. Đặc biệt ấn tượng với đội ngũ lắp đặt chuyên nghiệp và gọn gàng."</p>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md border border-[#D4BFA6] hover:shadow-lg transition-shadow">
                            ...
                            <p className="italic text-gray-700 border-l-4 border-[#D4BFA6] pl-4 py-1">"Tôi đã tìm hiểu nhiều nơi và quyết định chọn dịch vụ tại đây. Kết quả hoàn toàn xứng đáng, rèm đẹp và chất lượng vượt mong đợi."</p>
                        </div>
                    </div>
                </div>
            </section>
